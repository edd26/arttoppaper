...
for set_index = 1
    ...
    dipha_files_folder = '../../data/exp_pro/dipha_results/Heatmaps/kernel=gauss/size=81/dipha_export/';
    dipha_persitence_info_export_folder = '../../data/exp_pro/bd-data/Heatmaps/';

    files_list = dir(dipha_files_folder);
    export_folder = dir(dipha_persitence_info_export_folder);
