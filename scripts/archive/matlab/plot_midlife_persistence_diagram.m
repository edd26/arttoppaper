...
function [plt] = plot_midlife_persistence_diagram(filename, persistence_threshold)
    %% default values
    if nargin < 2
    ...
    plt = scatter(midlife(essentials), persistence(essentials), marker_size, cur_colormap(-dims(essentials) - 1 + 1, :), ...
