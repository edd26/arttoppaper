...
function [plt] = plot_persistence_diagram(filename, persistence_threshold)
    %% default values
    if nargin < 2
    ...
    plt = scatter(births(essentials), deaths(essentials), marker_size, cur_colormap(-dims(essentials) - 1 + 1, :), ...
